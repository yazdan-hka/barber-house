...
urlpatterns = [
    ...
    path('api/register/braider/', views.RegisterBraiderAPIView.as_view(), name='braider-register'),
    path('api/register/customer/', views.RegisterCustomerAPIView.as_view(), name='customer-register'),
    path('api/login/braider/', views.LoginBraiderAPIView.as_view(), name='braider-login'),
    path('api/login/customer/', views.LoginCustomerAPIView.as_view(), name='customer-login'),
